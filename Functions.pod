...
you so desire. What this does mean, however, is that a lot of things
that used to be function calls of the form C<function(@args)> can now
method calls of the form C<@args.function>. This should be obvious in
the following text, but it probably behooves you to get into that frame
of mind now.
